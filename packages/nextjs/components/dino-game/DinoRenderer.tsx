...
const drawObstacle = (
  ...
  if (obstacle.type === 'cactus') {
    ...
    if (gameImages.obstacles.bird.length > 0) {
      ctx.drawImage(
        gameImages.obstacles.bird[birdFrame],
        obstacle.x,
        obstacle.y,
        obstacle.width,
        obstacle.height
